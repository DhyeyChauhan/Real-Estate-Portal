...
<!--	Title
	=========================================================-->
<title>APNA GHAR - Find your dream house</title>
</head>
<body>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1><h4 class="mb-4"><span class="text-success">Find Your APNA GHAR........</h4></span>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Selling Service<br><h6>(To Selling Properties)</h6></a></h5>
                                <p>Seamlessly navigate the process of selling your property with our expert services....</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Rental Service<br><h6>(To find Rent/PG House)</h6></a></h5>
                                <p>Find the perfect rental property with our comprehensive rental services....</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-list text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Property Listing<br><h6>(List of Properties)</h6></a></h5>
                                <p>Showcase your property effectively through our dynamic property listings....</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Legal Investment<br><h6>(To Upcoming Projects)</h6></a></h5>
                                <p>Stay ahead with informed decisions on upcoming property projects through our legal investment guidance....</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Trust in our reputation for excellence in real estate.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Elevate your property journey with our commitment to exceptional service.
</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Rely on our experienced professionals to guide you every step of the way.</p>
									</div>
                                </li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Discover the ins and outs of real estate through engaging discussions.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Delve into file reviews to assess properties and make informed decisions.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Acquire your dream property with confidence through our seamless process.</p>
                        </div>
                    </div>
                </div>
            </div>
...
chatbotId: "efN4qwCvWdG6IHHT9ag-1",
